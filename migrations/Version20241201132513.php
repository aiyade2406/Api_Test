 ...
 */
final class Version20241201132513 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produits ADD categorie_id INT NOT NULL, ADD prix NUMERIC(10, 2) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produits DROP categorie_id, DROP prix');
    }
}
