 ...
 */
class getCatégoriesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CatégoriesRepository' shared autowired service.
     *
     * @return \App\Repository\CatégoriesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CatégoriesRepository.php';

        return $container->privates['App\\Repository\\CatégoriesRepository'] = new \App\Repository\CatégoriesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
